...
const FeaturedCar = ({featuredCar}) => {
    const {name, price, img, description, rating, _id} = featuredCar;
    return (
      <>
        <Grid item xs={12} md={4}>
          ...
          >
            ...
            <Typography
              ...
              style={{ color: "#130f40", textAlign: "center" }}
            >
              {name}
            </Typography>
            <Typography
            ...
            >
              {description.slice(0, 100)} <Link to="/explore">..Read More</Link>
            </Typography>
